...
> ⛔ **SUPERSEDED 2026-07-27 — 집행 금지.** 유저 확정 옵션C(사르르 CRM을 thinkmap DB로 완전 통합)로
> 대체됨. FDW/크로스프로젝트 통로 접근 폐기. **정본 = `crm-archive/INTEGRATION-MIGRATION-PLAN.md`**.
> 이 문서의 FDW/A3+B2+C1 통로 설계는 더 이상 유효하지 않다(guardian 2026-07-27 R2).
